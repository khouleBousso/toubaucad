...
(function($, undefined){
	...
	var dates = $.fn.datepicker.dates = {
		fr: {
			days: ["Dimanche", "Lundi", "Mardi", "Mercredi", "Jeudi", "Vendredi", "Dimanche", "Lundi"],
			daysShort: ["Dim", "Lun", "Mar", "Mer", "Jeu", "Ven", "Sam", "Dim"],
			daysMin: ["Dim", "Lun", "Mar", "Mer", "Jeu", "Ven", "Sam", "Dim"],
			months: ["Janvier", "Fevrier", "Mars", "Avril", "Mai", "Juin", "Juillet", "Aout", "Septembre", "Octobre", "Novembre", "Decembre"],
			monthsShort: ["Janvier", "Fevrier", "Mars", "Avril", "Mai", "Juin", "Juillet", "Aout", "Septembre", "Octobre", "Novembre", "Decembre"],
			today: "Today",
			clear: "Clear"
		}
	};
	...
	var DPGlobal = {
		...
		parseDate: function(date, format, language){
			...
			date = new Date();
			var parsed = {},
				setters_order = ['yyyy', 'yy', 'M', 'dd', 'd', 'dd', 'M', 'MM'],
				setters_map = {
					yyyy: function(d,v){
